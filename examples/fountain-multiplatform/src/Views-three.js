// fountain-specific views for THREE

/* global MyModelRoot */

const { ViewRoot, Pawn, mix, InputManager, PM_ThreeVisible, ThreeRenderManager, PM_Spatial, THREE, PM_Smoothed, toRad, m4_rotation, m4_multiply,
    WidgetManager2, Widget2, ButtonWidget2, TAU, m4_translation, v3_transform, ThreeInstanceManager,
    PM_ThreeInstanced, ViewService, App, StartWorldcore } = globalThis.Worldcore;
...
class SprayPawn extends mix(Pawn).with(PM_Smoothed, PM_ThreeInstanced) {
    constructor(...args) {
        super(...args);
        this.useInstance(this.actor.type + this.actor.index);
    }
}
