...
function packKey(x,y) {
    if (x < 0 || y < 0 ) console.warn("Negative grid coordinates are not allowed!");
...
export const AM_OnGrid = superclass => class extends superclass {
    ...
    translationSet(value, old) {
        ...
        if (!this.parent || !this.parent.isGrid) console.error("AM_OnGrid must have an AM_Grid parent!");
