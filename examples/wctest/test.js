...
class MyViewRoot extends ViewRoot {
    constructor(model) {
        ...
        this.widget0 = new BoxWidget2(this.ui.root, {anchor: [0,0], pivot: [0,0], autoSize: [0,0], size:[200,100], color:[0,0,0], local:[20,20]});
        ...
        this.widget3a = new ToggleWidget2(this.ui.root, {anchor: [0,0], pivot: [0,0], size: [200,100], local:[-20,-20]});
        this.toggleSet = new ToggleSet2(this.widget3, this.widget3a);

        this.frame = new BoxWidget2(this.ui.root, {anchor: [1,1], pivot: [1,1], size:[200,500], local:[-20,-20], color:[1,0,0], scale:1});
        this.imageWidget = new NineSliceWidget2(this.frame, {autoSize: [1,1], border:[5,5,5,5], size:[100,100], local:[0,0], url: diana, inset:[64,64,64,64], insetScale:1});
        ...
        this.widget4 = new BoxWidget2(this.ui.root, {anchor: [0.5,0.5], pivot: [0.5,0.5], size: [400,400], border:[5,5,5,5], local:[0,0], color:[0,0,0], scale:0.5});
