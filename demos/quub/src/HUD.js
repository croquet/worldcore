...
export class HUD extends Widget {
    ...
    buildGameScreen() {
        ...
        const whiteToggle = new ToggleWidget({parent: this, local: [10,10], size:[30,30]});
        this.setColorDefaults(whiteToggle, 1);

        const grayToggle = new ToggleWidget({parent: this, local: [45,10], size:[30,30]});
        this.setColorDefaults(grayToggle, 2);

        const blackToggle = new ToggleWidget({parent: this, local: [80,10], size:[30,30]});
        this.setColorDefaults(blackToggle, 3);

        const redToggle0 = new ToggleWidget({parent: this, local: [10,45], size:[30,30]});
        this.setColorDefaults(redToggle0, 4);

        const redToggle1 = new ToggleWidget({parent: this, local: [45,45], size:[30,30]});
        this.setColorDefaults(redToggle1, 5);

        const redToggle2 = new ToggleWidget({parent: this, local: [80,45], size:[30,30]});
        this.setColorDefaults(redToggle2, 6);

        const orangeToggle0 = new ToggleWidget({parent: this, local: [10,80], size:[30,30]});
        this.setColorDefaults(orangeToggle0, 7);

        const orangeToggle1 = new ToggleWidget({parent: this, local: [45,80], size:[30,30]});
        this.setColorDefaults(orangeToggle1, 8);

        const orangeToggle2 = new ToggleWidget({parent: this, local: [80,80], size:[30,30]});
        this.setColorDefaults(orangeToggle2, 9);

        const yellowToggle0 = new ToggleWidget({parent: this, local: [10,115], size:[30,30]});
        this.setColorDefaults(yellowToggle0, 10);

        const yellowToggle1 = new ToggleWidget({parent: this, local: [45,115], size:[30,30]});
        this.setColorDefaults(yellowToggle1, 11);

        const yellowToggle2 = new ToggleWidget({parent: this, local: [80,115], size:[30,30]});
        this.setColorDefaults(yellowToggle2, 12);

        const greenToggle0 = new ToggleWidget({parent: this, local: [10,150], size:[30,30]});
        this.setColorDefaults(greenToggle0, 13);

        const greenToggle1 = new ToggleWidget({parent: this, local: [45,150], size:[30,30]});
        this.setColorDefaults(greenToggle1, 14);

        const greenToggle2 = new ToggleWidget({parent: this, local: [80,150], size:[30,30]});
        this.setColorDefaults(greenToggle2, 15);

        const blueToggle0 = new ToggleWidget({parent: this, local: [10,185], size:[30,30]});
        this.setColorDefaults(blueToggle0, 16);

        const blueToggle1 = new ToggleWidget({parent: this, local: [45,185], size:[30,30]});
        this.setColorDefaults(blueToggle1, 17);

        const blueToggle2 = new ToggleWidget({parent: this, local: [80,185], size:[30,30]});
        this.setColorDefaults(blueToggle2, 18);

        const purpleToggle0 = new ToggleWidget({parent: this, local: [10,220], size:[30,30]});
        ...
        const deleteToggle = new ToggleWidget({parent: this, local: [10,255], size:[100,30]});
        ...
        deleteToggle.set({labelOn: new ImageWidget({border: [5,5,5,5], url: stripeIcon })});
        deleteToggle.set({labelOff: new ImageWidget({border: [5,5,5,5], url: stripeIcon })});

        deleteToggle.set( {onToggleOn: () => this.setEditColor(0) });
        ...
        const cutawaySlider = new SliderWidget({
            ...
            onChange: p => SetTopLayer(Math.round(1 + (1-p) * (Voxels.sizeZ-1)))
        });
    ...
    setColorDefaults(toggle, color) {
        ...
        toggle.set( {labelOn: new BoxWidget({border: [5,5,5,5], color: Colors[color] })});
        toggle.set( {labelOff: new BoxWidget({border: [5,5,5,5], color: Colors[color] })});
        toggle.set( {onToggleOn: () => this.setEditColor(color) });
