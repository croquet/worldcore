import { RegisterMixin, WorldcoreModel, Shuffle, Model } from "@croquet/worldcore-kernel";
...
// Inside the Script object you can reference the actor by this.target
// For example this.target.say("updateCode", name);

export const AM_Scriptable = superclass => class extends superclass {

    init(...args) {
        super.init(...args);
        this.script = Script.create();
        this.script.target = this;
    }
