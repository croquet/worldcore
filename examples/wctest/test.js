...
class MyViewRoot extends ViewRoot {
    constructor(model) {
        ...
        this.widget3 = new ToggleWidget2(this.ui.root, {anchor: [0,0], pivot: [0,0], size: [200,100], local:[0,0]});
        this.widget3a = new ToggleWidget2(this.ui.root, {anchor: [0,0], pivot: [0,0], size: [200,100], local:[0,0]});
        ...
        this.toggleSet = new ToggleSet2();
        this.widget3.set({toggleSet: this.toggleSet});
        this.widget3a.set({toggleSet: this.toggleSet});
        ...
        this.widget5 = new ButtonWidget2(this.canvas2, {anchor: [0,0], pivot: [0,0], size: [200,100], local:[1,1], disabled: true});
